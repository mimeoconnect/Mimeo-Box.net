...
//  This is an existing document template - Spiral (small) -  Black & White
//  A custom template can be used or other sample templates can be requested
$documentTemplateId = "97050908-1266-4c95-b7bc-a4245160de41";
...
//  This is a multi-page document.  So only 1 PDF is needed with the range of pages for this document.  X represents the last page
$xml->Product->Content->DocumentSection[0]->Source = $PDF_URL;
$xml->Product->Content->DocumentSection[0]->Range = "[1,X]";
